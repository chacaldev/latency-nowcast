...
timestr = "%d %b %Y %H:%M:%S"
model_folder = "models/"
result_folder = "results/lstm_daily/owd/"
skip_existent_model = True

logging.basicConfig(filename="diff_lstm_week_log.txt", level=logging.INFO)
...
for seg in segments:
    generate_model('Datasets/owd_parquet/owd-'+seg+'_diff1pre.gzip', 'owd-diff'+seg)
